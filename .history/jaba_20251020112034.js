...
window.addEventListener("load", () => {
  ...
  if (savedContinent) {
    ...
    changeVisibility(continent);

    // Wait a bit for rendering and images to load before scrolling
    setTimeout(() => {
    ...
    }, 600); // wait longer to ensure the layout is ready
  }
});
...
function changeVisibility(continent) {
