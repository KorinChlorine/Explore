...
function renderFood(Foods){
 const carouselInner = document.querySelector("#foodCarousel .carousel-inner");
  const indicators = document.querySelector("#foodCarousel .carousel-indicators");
  ...
  Foods.forEach((food, index) => {
    ...
    item.innerHTML = `
      ...
      <img src="${food.image}" class="img-fluid rounded mb-3" alt="${food.name}">
    ...
    button.type = "button";
    button.setAttribute("data-bs-target", "#foodCarousel");
